...
import { Typography, Input, Button, Form, Select,InputNumber,DatePicker, Space  ,Modal} from "antd";
  ...
  return (
    <>
      ...
      <Form
        ...
        onSubmit
      >
        <Typography.Title variant="h5">ajouter un transport Urgent</Typography.Title>
        <Button type="primary" onClick={showModal}>
    Transmettre vers une Etbls
    </Button>
  <Modal title="Transmettre" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
<div className="">
 <div className="">  
 <input></input>
 </div>

 <Button onClick  className="btn-qr">envoyer </Button> 
 </div> ,
 </Modal>
        <Form.Item label="nom">
          <Input
